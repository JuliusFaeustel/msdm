...
# Ausgabe
datei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/Ergebnisse/005Taktung_pro_Ladungsträger/Taktung_pro_LadungsträgerCSV.txt","w")
...
for Teil in Teil_List:
    ...
    for LagerIn in LagerIn_List:
        ...
        # Ausgabe pro FA
        datei.write("LagerIn:"+LagerIn[0]+";"+str(maxTime)+";"+str(minTime)+";"+str(avgTime)+"\n")
