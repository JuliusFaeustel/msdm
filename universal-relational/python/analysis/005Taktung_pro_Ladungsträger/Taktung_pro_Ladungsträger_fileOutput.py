...
# Ausgabe
datei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/Ergebnisse/005Taktung_pro_Ladungsträger/Taktung_pro_Ladungsträger.txt","w")
...
for Teil in teil_array:
    ...
    for LagerIn in LagerIn_List:
        ...
        datei.write("Ladungsträger: "+LagerIn[0]+"            Anzahl gefertigt: "+str(Anzahl[0])+"            MIN: "+convert_from_s(minZeit)+"            MAX: "+convert_from_s(maxZeit)+"            AVG: "+convert_from_s(avgZeit)+"\n")

        avg_list.append(avgZeit/60)
    ...
    plt.xlabel('Teilart')
    plt.axis
    plt.boxplot(avg_list, labels=[Teil[0]], showfliers=False, positions=[i+1])
