...
# Ausgabe
datei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/Ergebnisse/004Ladungsträger/LadungsträgerCSV.txt","w")

datei.write("Lager;Start;Ende;Dauer;Anzahl\n")
...
for LagerIn in LagerIn_List:
    ...
    # Ausgabe
    datei.write("LagerIn:"+LagerIn[0]+";"+minInputDate[:19]+";"+maxOutputDate[:19]+";"+str(Dauer)+";"+str(AnzahlProLad[0])+"\n")
