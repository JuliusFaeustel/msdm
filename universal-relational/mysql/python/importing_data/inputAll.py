...
Zeitdatei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/mysql/Ergebnisse/InputZeit.csv","w")
Querydatei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/mysql/Ergebnisse/InputQuery.csv","w")
...
for filename in files:
    ...
    #print("Durchlaufzeit DB: "+str(DurationDB[0])+" s")
    Zeitdatei.write(str(DurationDB[0])+";")
    #print("Queries DB: "+str(QueryCount[0]-1))
    Querydatei.write(str(QueryCount[0])+";")    
