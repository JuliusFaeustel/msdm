...
#Zeitdatei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/mssql/Ergebnisse/InputZeit.csv","w")
#Querydatei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/mssql/Ergebnisse/InputQuery.csv","w")

# alle Files aus Ordner
files = glob.glob("C:/Users/picht/Desktop/Projektseminar I-490/data/htw/in/*.txt")
...
for filename in files:
    ...
    statement = "INSERT INTO SNR VALUES (" + data[pos_SNR] + "," + data [pos_FA] + "," + data [pos_TEIL] + "," + data [pos_LINIE] + ")"
    cursor.execute(statement)
    connection.commit()
    ...
    for Merk_ID, value in zip(merkmalID_List, data):
        ...
        if value != 'NULL':
            ...
            if not result:
                statement = "INSERT INTO Objekt2Merkmal VALUES (" + str(Merk_ID) + "," + str(SNRID) + ", " + str(ObjektTypSNR) + ")"
                cursor.execute(statement)
                connection.commit()
            ...
            if not result:
                statement = "INSERT INTO Objekt2Merkmalsausprägung VALUES (" + str(AuspraegungsID) + ", " + str(SNRID) + ", " + str(ObjektTypSNR) + ")"
                cursor.execute(statement)
                connection.commit() 
