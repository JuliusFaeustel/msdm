...
# Ausgabe
datei = open("C:/Users/picht/Desktop/Projektseminar I-490/universell-relational/mssql/Ergebnisse/007Umrüstung/Umrüstung.csv","w")
...
for Linie in Linie_List:
    ...
    statement = "SELECT SNR.FA FROM SNR WHERE SNR.LINIE = '"+Linie[0]+"' GROUP BY SNR.FA"
    cursor.execute(statement)
